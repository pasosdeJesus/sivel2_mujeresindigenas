...
SELECT pg_catalog.setval('public.estadocaso_id_seq', 4, true);
...
INSERT INTO public.consecuenciafamiliar (id, nombre, observaciones, fechacreacion, fechadeshabilitacion, created_at, updated_at) VALUES (4, 'DESINTEGRACION COLECTIVA', NULL, '2016-06-07', NULL, '2016-06-07 00:00:00', '2016-06-07 00:00:00');
...
SELECT pg_catalog.setval('public.consecuenciafamiliar_id_seq', 101, true);
...
SELECT pg_catalog.setval('public.consecuenciaindividual_id_seq', 101, true);
...
SELECT pg_catalog.setval('public.educacionpropia_id_seq', 102, true);
...
SELECT pg_catalog.setval('public.motivonodenuncia_id_seq', 102, true);
...
SELECT pg_catalog.setval('public.religion_id_seq', 103, true);
...
SELECT pg_catalog.setval('public.tafectacion_id_seq', 102, true);
...
SELECT pg_catalog.setval('public.tapoyo_id_seq', 102, true);
